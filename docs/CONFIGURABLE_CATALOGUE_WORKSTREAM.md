...
| 2026-07-29 | WP-CC-02 Staff catalogue and images      | `feature/wp-cc-02-catalogue-admin`, starting SHA `59d96e6473d977b01e14db4468d91327aa6904e4`; original local commit `f18a9b10a5681e7ee4e81c567a9b9d2264ca77d4`; per-choice correction commit is branch HEAD and must be verified from Git         | Staff group/choice/topping management, availability, deterministic stable IDs, Product assignments, atomic public projection synchronization, image rollback, Storage Rules, and the guarded isolated-UAT workflow remain intact. The QA correction makes `optionGroups/{groupId}/choices/{choiceId}` the sole mutable Choice authority, keeps group documents metadata-only, makes removal archive-only, denies lifecycle reversal and physical deletion, and preserves explicit legacy embedded reads. Atomic 50-Choice create/reorder proofs passed. Focused 41/41, full application 410/410, Firestore Rules 25/25, and Storage Rules 3/3 passed; TypeScript, lint, Production build, actionlint, formatting/LF, diff, and credential checks passed. Offline dry runs retained fingerprint `cc3-62a7a5c1ee582c6a`, with 31 planned/0 performed then 0 planned/0 performed. No push, PR, merge, deployment, remote Firebase, WP-CC-03, or PR #14 action. |
